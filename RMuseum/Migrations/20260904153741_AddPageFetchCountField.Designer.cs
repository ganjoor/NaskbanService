...
namespace RMuseum.Migrations
{
    ...
    [Migration("20260904153741_AddPageFetchCountField")]
    partial class AddPageFetchCountField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RMuseum.Models.PDFLibrary.AIQueue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RMuseum.Models.PDFLibrary.GanjoorPoemMatchFinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("CurrentPageNumber")
                        .HasColumnType("int");

                    b.Property<int>("CurrentPoemId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("GanjoorPoemMatchFindings");
                });
            ...
            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFBookDuplicateCandidate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("PDFBookId1")
                        .HasColumnType("int");

                    b.Property<int>("PDFBookId2")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SurvivorPDFBookId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFBookDuplicateDetectionState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("LastProcessedTitleBucketKey")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("LastRunStarted")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("LastRunUpdated")
                        .HasColumnType("datetime2");

                    b.Property<int>("ProcessedTitleBuckets")
                        .HasColumnType("int");

                    b.Property<int>("TotalTitleBuckets")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("PDFBookDuplicateDetectionStates");
                });

            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFBookRedirect", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PDFBookRedirects");
                });

            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFBookReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PDFBookReports");
                });

            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFBookReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PDFBookId", "UserId")
                        .IsUnique()
                        .HasFilter("[Status] = 4");

                    b.ToTable("PDFBookReviews");
                });

            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFBookReviewReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PDFBookReviewId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PDFBookReviewId");

                    b.HasIndex("ReporterId");

                    b.HasIndex("ReviewerId");

                    b.ToTable("PDFBookReviewReports");
                });

            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFBookReviewVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PDFBookReviewId", "UserId")
                        .IsUnique();

                    b.ToTable("PDFBookReviewVotes");
                });
            ...
            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFPageComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double?>("HighlightHeight")
                        .HasColumnType("float");

                    b.Property<double?>("HighlightWidth")
                        .HasColumnType("float");

                    b.Property<double?>("HighlightX")
                        .HasColumnType("float");

                    b.Property<double?>("HighlightY")
                        .HasColumnType("float");
                    ...
                    b.ToTable("PDFPageComments");
                });

            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFPageCommentReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PDFPageCommentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PDFPageCommentId");

                    b.HasIndex("ReporterId");

                    b.HasIndex("ReviewerId");

                    b.ToTable("PDFPageCommentReports");
                });

            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFPageUnrevisedText", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PDFPageUnrevisedTexts");
                });

            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFPinnedAuthor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PDFPinnedAuthors");
                });

            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFShelf", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("ClientModifiedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("PDFShelves");
                });

            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFShelfBook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PDFShelfId");

                    b.ToTable("PDFShelfBooks");
                });
            ...
            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFUserBookmark", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PDFUserBookmarks");
                });

            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PendingPDFStorageCleanup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("NeedsFtpDelete")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("PendingPDFStorageCleanups");
                });
            ...
            modelBuilder.Entity("RMuseum.Models.PDFUserTracking.PDFStudyLogEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PDFStudyLogEntries");
                });

            modelBuilder.Entity("RMuseum.Models.PDFUserTracking.PDFVisitRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("QueryPageNumber")
                        .HasColumnType("int");

                    b.Property<int?>("QueryPageSize")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RAppUserId", "PDFBookId");

                    b.ToTable("PDFVisitRecords");
                });
            ...
            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFBookReport", b =>
                {
                    b.HasOne("RMuseum.Models.PDFLibrary.PDFBook", "PDFBook")
                        .WithMany()
                        .HasForeignKey("PDFBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFBookReviewReport", b =>
                {
                    b.HasOne("RMuseum.Models.PDFLibrary.PDFBookReview", "PDFBookReview")
                        .WithMany()
                        .HasForeignKey("PDFBookReviewId")
            ...
            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFPageComment", b =>
                {
                    ...
                    b.HasOne("RMuseum.Models.PDFLibrary.PDFPageComment", "InReplyTo")
                        .WithMany()
                        .HasForeignKey("InReplyToId");

                    b.HasOne("RMuseum.Models.PDFLibrary.PDFPage", "PDFPage")
                        .WithMany()
                        .HasForeignKey("PDFPageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFShelfBook", b =>
                {
                    ...
                    b.HasOne("RMuseum.Models.PDFLibrary.PDFShelf", "PDFShelf")
                        .WithMany()
                        .HasForeignKey("PDFShelfId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PDFBook");

                    b.Navigation("PDFShelf");
                });
            ...
            modelBuilder.Entity("RMuseum.Models.PDFLibrary.PDFUserBookmark", b =>
                {
                    ...
                    b.HasOne("RMuseum.Models.PDFLibrary.PDFPage", "Page")
                        .WithMany()
